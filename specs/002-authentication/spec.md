...
- **Password policy as-is**: The constitution's current password rules are used unchanged. Breached-password screening is a deliberate later addition (tracked as GitHub issue #11), not part of this feature.
