...
- Q: How are cancellation notices (and future participant notifications) delivered this iteration? → A: **Email** — transactional email via the existing Mailpit/Resend infrastructure, consistent with feature 005's targeted invites. A general in-app notification system remains a separate Backlog.md item.
