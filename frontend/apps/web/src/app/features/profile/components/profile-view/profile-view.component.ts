...
import { CardComponent, ChipDirective, IconComponent } from '../../../../shared/ui';
...
@Component({
  ...
  imports: [RouterLink, RecognitionDisplayComponent, TranslocoPipe, CardComponent, ChipDirective, IconComponent],
