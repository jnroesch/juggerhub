...
import { ButtonDirective, CardComponent, ChipDirective, EmptyStateComponent, LoadingComponent } from '../../../shared/ui';
...
@Component({
  ...
  imports: [CardComponent, ChipDirective, TranslocoDatePipe, FormsModule, ButtonDirective, LoadingComponent, EmptyStateComponent, TranslocoPipe],
