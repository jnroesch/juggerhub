        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DirectPairKey = table.Column<string>(type: "character varying(73)", maxLength: 73, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Conversations_Parties_PartyId",
                        column: x => x.PartyId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SystemEvent = table.Column<int>(type: "integer", nullable: true),
                    SystemSubjectUserId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_DirectPairKey",
                table: "Conversations",
                column: "DirectPairKey",
                unique: true,
                filter: "\"DirectPairKey\" IS NOT NULL");
