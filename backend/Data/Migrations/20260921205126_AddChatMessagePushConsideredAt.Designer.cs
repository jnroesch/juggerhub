...
namespace JuggerHub.Data.Migrations
{
    ...
    [Migration("20260921205126_AddChatMessagePushConsideredAt")]
    partial class AddChatMessagePushConsideredAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JuggerHub.Entities.ChatAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ChatMessageId", "Ordinal");
            ...
            modelBuilder.Entity("JuggerHub.Entities.ChatMessage", b =>
                {
                    ...
                    b.Property<DateTime?>("PushConsideredAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("JuggerHub.Entities.Conversation", b =>
                {
                    ...
                    b.HasIndex("TeamId")
                        .IsUnique()
                        .HasFilter("\"TeamId\" IS NOT NULL AND \"Kind\" = 2");

                    b.HasIndex("EventId", "RequesterUserId")
                        .IsUnique()
                        .HasFilter("\"Kind\" = 5");

                    b.HasIndex("TeamId", "RequesterUserId")
                        .IsUnique()
                        .HasFilter("\"Kind\" = 4");
            ...
            modelBuilder.Entity("JuggerHub.Entities.PushSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("JuggerHub.Entities.TeamLogo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("JuggerHub.Entities.TrainingSession", b =>
                {
                    ...
                    b.Property<Guid?>("CityIdOverride")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PostalCodeOverride")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
                    ...
                    b.Property<string>("StreetOverride")
                        .HasMaxLength(160)
                        .HasColumnType("character varying(160)");
                    ...
                    b.Property<string>("VenueNameOverride")
                        .HasMaxLength(120)
                        .HasColumnType("character varying(120)");
            ...
            modelBuilder.Entity("JuggerHub.Entities.ChatAttachment", b =>
                {
                    b.HasOne("JuggerHub.Entities.ChatMessage", "Message")
            ...
            modelBuilder.Entity("JuggerHub.Entities.Conversation", b =>
                {
                    ...
                    b.HasOne("JuggerHub.Entities.User", "Requester")
                        .WithMany()
            ...
            modelBuilder.Entity("JuggerHub.Entities.TeamLogo", b =>
                {
                    b.HasOne("JuggerHub.Entities.Team", "Team")
                        .WithOne("Logo")
                        .HasForeignKey("JuggerHub.Entities.TeamLogo", "TeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("JuggerHub.Entities.TrainingSession", b =>
                {
                    b.HasOne("JuggerHub.Entities.City", "CityOverride")
                        .WithMany()
                        .HasForeignKey("CityIdOverride")
                        .OnDelete(DeleteBehavior.Restrict);
