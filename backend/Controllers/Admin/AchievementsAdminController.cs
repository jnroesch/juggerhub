...
public sealed class AchievementsAdminController : AdminControllerBase
{
    ...
    public async Task<IActionResult> Reinstate(Guid definitionId, CancellationToken ct) =>
        await _achievements.ReinstateDefinitionAsync(definitionId, ct) ? NoContent() : DefinitionNotFound();
    ...
    public async Task<IActionResult> SetIcon(Guid definitionId, CancellationToken ct)
    {
        ...
        var result = await _achievements.SetIconAsync(definitionId, bytes, ct);
    ...
    public async Task<IActionResult> RemoveIcon(Guid definitionId, CancellationToken ct) =>
        await _achievements.RemoveIconAsync(definitionId, ct) ? NoContent() : DefinitionNotFound();
